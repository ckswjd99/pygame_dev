...
class spark_circle(particle):
    ...
    def render(self):
        pygame.gfxdraw.filled_circle(screen, self.pos[0], self.pos[1], self.size, pygame.Color(self.color[0], self.color[1], self.color[2], int(255*(self.life_left/self.life))))
...
class spark_rectangle(particle):
    ...
    def render(self):
        pygame.gfxdraw.box(screen, pygame.Rect(self.pos[0]-self.size/2, self.pos[1]-self.size/2, self.size, self.size), pygame.Color(self.color[0], self.color[1], self.color[2],int(255*(self.life_left/self.life))))
...
class wave_circle(particle):
    ...
    def render(self):
        pygame.gfxdraw.aacircle(screen, self.pos[0], self.pos[1], self.size, pygame.Color(self.color[0], self.color[1], self.color[2], int(255*(self.life_left/self.life))))
...
class wave_rectangle(particle):
    ...
    def render(self):
        pygame.gfxdraw.rectangle(screen, pygame.Rect(self.pos[0]-self.size/2, self.pos[1]-self.size/2, self.size, self.size), pygame.Color(self.color[0], self.color[1], self.color[2],int(255*(self.life_left/self.life))))
...
class gas_circle(particle):
    ...
    def render(self):
        pygame.gfxdraw.filled_circle(screen, self.pos[0], self.pos[1], int(self.size*(self.life_left/self.life)), self.color)
